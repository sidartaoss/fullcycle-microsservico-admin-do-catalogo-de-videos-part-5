...
public class DefaultCreateVideoUseCase extends CreateVideoUseCase {
    ...
    public CreateVideoOutput execute(final CreateVideoCommand aCommand) {
        ...
        final var aBuilder = build(aCommand, aRating, aLaunchedAt, aCategories, aGenres, aCastMembers);
        final var aVideo = aNotification.validate(() -> Video.newVideo(aBuilder));
    ...
    private Video create(final CreateVideoCommand aCommand, final Video aVideo) {
        ...
        try {
            ...
            throw InternalErrorException.with("An error on create video was observed [videoId: %s]"
    ...
    private Video.Builder build(CreateVideoCommand aCommand, Rating aRating, Year aLaunchedAt, Set<CategoryID> aCategories, Set<GenreID> aGenres, Set<CastMemberID> aCastMembers) {
    ...
    private void notify(final Notification aNotification) {
        throw new NotificationException("Could not create Aggregate Video", aNotification);
    }
}
