...
public class CategoryController implements CategoryAPI {
    ...
    @Override
    public ResponseEntity<?> create(final CreateCategoryRequest aRequest) {
        final var aName = aRequest.name();
        final var aDescription = aRequest.description();
    ...
    @Override
    public ResponseEntity<?> update(final String anId, final UpdateCategoryRequest aRequest) {
        final var aName = aRequest.name();
        final var aDescription = aRequest.description();
        final var aCommand = UpdateCategoryCommand.with(anId, aName, aDescription);
    ...
    public ResponseEntity<?> activate(final String anId) {
        final Function<ActivateCategoryOutput, ResponseEntity<?>> onSuccess =
                ResponseEntity::ok;
        return activateCategoryUseCase.execute(anId)
                .fold(onError(), onSuccess);
    }
    ...
    public ResponseEntity<?> deactivate(final String anId) {
        final Function<DeactivateCategoryOutput, ResponseEntity<?>> onSuccess =
                ResponseEntity::ok;
        return deactivateCategoryUseCase.execute(anId)
                .fold(onError(), onSuccess);
    }
